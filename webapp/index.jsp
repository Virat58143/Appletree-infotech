...
<body>
    ...
    <div class="top-banner">
        <div class="banner">
            <div class="small-bold-text banner-text">
                <marquee id="banner-marquee header-marquee">
    ...
    <section>
        <div class="containor">
            ...
            <div class="course-area flex">
                ...
                <div class="course-card employee-card flex">
                    <img class="course-card-img" src="image/msme1-img.jpg" alt="">
                    <div class="overlay-text">Yeh Content Hover par Dikhega</div>
                </div>
                <div class="course-card employee-card flex">
                    <img class="course-card-img" src="image/msme2-img.jpg" alt="">
                    <div class="overlay-text">Yeh Content Hover par Dikhega</div>
                </div>
            </div>
        </div>
    ...
    <section class="cta-section">
        <div class="containor flex cta-section-containor">
            ...
            <a class= "primary-button" href="Contact.jsp">Contact</a>
        </div>
    </section>
