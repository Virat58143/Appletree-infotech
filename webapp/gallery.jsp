...
<body>
    ...
    <header>
        ...
        <div class="containor header-section1 flex">
            <div class="left">
        ...
        <div class="containor">
            ...
            <div class="course-area flex">
                <div class="course-card employee-card flex">
                    <img class="course-card-img" src="image/apple1-img.jpg" alt="">
                    <div class="overlay-text">UMESH CHANDRA<br>
						Founder of <br> AppleTree Infotech</div>
                </div>
                
                <div class="course-card employee-card flex">
                    <img class="course-card-img" src="image/banner2-img.jpg" alt="">
                    
                    
                </div>
                <div class="course-card employee-card flex">
                    <img class="course-card-img" src="image/banner3-img.jpg" alt="">
                </div>
                <div class="course-card employee-card flex">
                    <img class="course-card-img" src="image/banner-img.jpg" alt="">
                </div>
                <div class="course-card employee-card flex">
                    <img class="course-card-img" src="image/center-gallery-img.jpg" alt="">
                </div>
                <div class="course-card employee-card flex">
                    <img class="course-card-img" src="image/class1-img.jpg" alt="">
                </div>
                
                <div class="course-card employee-card flex">
                    <img class="course-card-img" src="image/class-board1-img.jpg" alt="">
                </div>
                
                <div class="course-card employee-card flex">
                    <img class="course-card-img" src="image/class-room-img.jpeg" alt="">
                    
                </div>
                <div class="course-card employee-card flex">
                    <img class="course-card-img" src="image/exit-img.jpg" alt="">
                </div>
                <div class="course-card employee-card flex">
                    <img class="course-card-img" src="image/fire-exit-img.jpg" alt="">
                </div>
                <div class="course-card employee-card flex">
                    <img class="course-card-img" src="image/lab-img.jpg" alt="">
                </div>
                <div class="course-card employee-card flex">
                    <img class="course-card-img" src="image/rk-tower img.jpg" alt="">
                </div>
                
                <div class="course-card employee-card flex">
                    <img class="course-card-img" src="image/certificate1-img.jpg" alt="">
                </div>
                
                <div class="course-card employee-card flex">
                    <img class="course-card-img" src="image/workshop1.jpeg" alt="">
                    
                </div>
                <div class="course-card employee-card flex">
                    <img class="course-card-img" src="image/certificate2-img.jpg" alt="">
                </div>
                
                <div class="course-card employee-card flex">
                    <img class="course-card-img" src="image/wifi-img.jpg" alt="">
                </div>
            </div>
        </div>
    </section>
